...
public abstract class HeuristicGamerSam extends StateMachineGamer {
	...
	public Move stateMachineSelectMove(long timeout)
		...
		_levelsToExpand = 2;
		List<Double> moveScores = getMove(currState, timeAllocatedPRE, legalMoves);
		...
		for(int i = 0; i<legalMoves.size(); i++){
			...
			if(moveScoresPOST.size()<i-1){
				...
				score += (moveScoresPOST.get(i) * 3)/5;  //THIS IS THE MONTE RATIO PART
			}
